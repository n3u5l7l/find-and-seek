...
export default function GameScreen() {
    ...
    <>
        ...
        <Game time={time} timeInterval={timeInterval} gameFinish={gameFinish} setGameFinish={setGameFinish} charFound={charFound} setCharFound={setCharFound} mapName={params.mapName} gameImage={thisMap[params.mapName].src} gameCharacter={thisMap[params.mapName].characters} cursorState={cursorDisplay} displayCursor={displayCursor}/>
    </> 
    );
}